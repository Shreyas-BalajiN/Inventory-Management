...
export default function Register() {
    ...
    console.log(payload)
    axios.post("https://custom-inventory-po3oww4fuq-wl.a.run.app/store/create",payload)
    .then((resp)=>{
    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-lg-6" style={{ backgroundColor: "grey" }}>
          ...
          <br />
          <br />
          <h5 style={{color:"white"}} className="d-flex justify-content-center">Already have an account ?</h5>
          <div className="d-flex justify-content-center">
