...
export default function Entry() {
  ...
  const handleLogin=(event)=>{
    ...
    axios.post("https://custom-inventory-po3oww4fuq-wl.a.run.app/store/open",payload)
    .then((resp)=>{
    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-lg-6" style={{ backgroundColor: "grey" }}>
          ...
          <br />
          <br />
          <h5 style={{color:"white"}} className="d-flex justify-content-center">Do not have an account ?</h5>
          <div className="d-flex justify-content-center">
